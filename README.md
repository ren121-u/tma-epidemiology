...
This repository contains SQL and R code to analyze ADAMTS13 testing, TMA and TTP diagnoses, and in-hospital mortality by the maximum PLASMIC score.

The data come from 6 ICUs in Japan between 2018 and 2025, recorded in the OneICU database. The SQL scripts extract PLASMIC scores and the presence of ADAMTS13 testing, TMA (including TTP), and in-hospital death. The R scripts then tabulate the proportion of patients undergoing ADAMTS13 testing, the frequency of TMA and TTP diagnoses, and mortality across PLASMIC score categories.
...
The study population consists of patients admitted to 6 ICUs in Japan where ADAMTS13 testing was available, between 2018 and December 2025. The following patients are excluded:
...
| Script | Contents |
| --- | --- |
| `01_plasmic_score.sql` | PLASMIC score for each patient |
...
| `04_all_data.sql` | ADAMTS13 testing, diagnoses, and mortality |
...
| File | Contents |
| --- | --- |
| `01_plasmic_table.R` | Proportion of patients undergoing ADAMTS13 testing, frequency of TMA and TTP diagnoses, and mortality, stratified by PLASMIC score |
